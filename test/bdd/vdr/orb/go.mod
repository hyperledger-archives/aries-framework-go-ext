...
require (
	...
	github.com/trustbloc/orb v1.0.1-0.20230929144409-1e0e7e685841 // indirect
...
replace github.com/hyperledger/aries-framework-go-ext/component/vdr/sidetree => ../../../../component/vdr/sidetree
