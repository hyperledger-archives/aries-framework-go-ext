...
import (
	...
	"github.com/hyperledger/aries-framework-go-ext/test/bdd/vdr/trustbloc/dockerutil"
	bddctx "github.com/hyperledger/aries-framework-go-ext/test/bdd/vdr/trustbloc/pkg/context"
	"github.com/hyperledger/aries-framework-go-ext/test/bdd/vdr/trustbloc/pkg/vdr"
)
...
func runBDDTests(tags, format string) int { //nolint: gocognit
	return godog.RunWithOptions("godogs", func(s *godog.Suite) {
		...
		composeFiles := []string{"./fixtures/sidetree-mock"}
		s.BeforeSuite(func() {
