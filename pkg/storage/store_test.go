...
import (
	...
	"github.com/hyperledger/aries-framework-go-ext/pkg/storage"
	couchdbstore "github.com/hyperledger/aries-framework-go-ext/pkg/storage/couchdb"
	"github.com/hyperledger/aries-framework-go-ext/pkg/storage/mysql"
)
...
const (
	...
	dockerCouchdbVolume = "%s/couchdb/single-node.ini:/opt/couchdb/etc/local.d/single-node.ini"
